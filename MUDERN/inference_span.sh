...
#  OUT="span_${MODEL}_BZ${BZ}_EP${EPOCH}_LR${LR}_MAXTOPK${TOPK}_seed${SEED}"
  ...
  $PYT -m torch.distributed.launch \
    ...
    --fp16 \
    --overwrite_cache \
    --validation_qa_prediction_file=./out/${OUT}/predictions_dev.npy \
    --test_qa_prediction_file=./out/${OUT}/predictions_test.npy
}
...
#87	1580
#11	948
SPAN_MODEL=/research/dept7/ik_grp/lijj/open_retrieval_sharc_private/mpdiscern/out/span_roberta-base_BZ8_EP10_LR5e-5_MAXTOPK100_seed${SEED}/checkpoint-${CKPT}
DECISION_MODEL=v9_roberta-base_Lentail8.0_Ltrans4_seed${SEED}
